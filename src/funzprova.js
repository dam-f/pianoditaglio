...
let sfridi = [[20, 100], [20, 180], [2, 220], [20, 70]];
...
function ciStaAncora(misura, comb, barraRimanente = 650) {
  ...
  if (
    misura < 650 - lungTemp &&
    (650 - lungTemp - misura > minSfrido || 650 - lungTemp - misura < maxScarto)
  ) {
...
function pianoConStatistiche(ordine) {
  ...
  pianoDiTaglioCompleto.unshift([
    "Barre utilizzate: " + barreUtilizzate,
    "Scarto totale: " + scartoTotale
  ]);
  pianoDiTaglioCompleto.push(
